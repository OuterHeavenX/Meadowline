...
import { resetJuiceOverlay } from '../rendering/overlay.js';
...
function changed(){S.rendererMode=renderer.value;S.quality=quality.value;resetThreeRenderer();resetRendererBackend();resetJuiceOverlay();resize();save();}
