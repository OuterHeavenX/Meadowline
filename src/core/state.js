...
export const S={
  ...
  citizens:[],trains:[],boats:[],puffs:[],pop:0,mood:0,homes:0,
  ...
  diagnostics:{enabled:false,frames:0,fps:0,frameMs:0,simMs:0,renderMs:0,pathSearches:0,saveBytes:0,housingEvaluations:0,housingUpgrades:0,desirabilityRecomputes:0,progressionRecomputes:0,milestoneEvaluations:0,parcelUnlocks:0,buildingUnlocks:0,schoolUpgrades:0,goalRecomputes:0,goalReplacements:0,primaryGoal:'',optionalGoal:'',inputState:'IDLE',touchPans:0,tapPlacements:0,paintActivations:0,cancelledBuildByDrag:0,cancelledBuildByPinch:0},
