...
export const S={
  ...
  coins:340,day:1,dayT:.24,t:0,speed:1,muted:false,running:true,tool:'move',
  ...
  social:{districts:[],nextId:0,families:[],nextFamilyId:0,firsts:{},organisations:[],nextOrgId:0,orgMemory:{},fame:[],aliases:[],petitions:[]},
