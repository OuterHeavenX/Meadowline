...
export const TOOLS=[
  ...
  {id:"signal",name:"Signal",  cost:25, key:"z", desc:"Sits on a road. Keeps a busy crossroads in order \u2014 and the traffic stops at red.", cat:"ways"},
  ...
  {id:"clinic",name:"Clinic",  cost:160,key:"h", desc:"Takes the edge off a crowded street, and lifts the mood for five tiles.", cat:"homes"},
  {id:"well",  name:"Well",    cost:15, key:"j", desc:"A small, cheap comfort for the houses right around it.", cat:"homes"},
  {id:"farm",  name:"Farm",    cost:60, key:"f", desc:"Grows the grain the windmills need. Wants open ground around it.", cat:"food"},
  {id:"mill",  name:"Windmill",cost:95, key:"9", desc:"Grinds coin every day \u2014 most of all at harvest. Wants open ground.", cat:"food"},
  {id:"bakery",name:"Bakery", cost:80, key:"k", desc:"Bakes what the windmills grind. Wants a mill within four tiles.", cat:"food"},
  {id:"cafe",  name:"Caf\u00e9",   cost:55,  key:"5", desc:"Earns coins every day and cheers up the street.", cat:"food"},
  {id:"market",name:"Market", cost:130,key:"r", desc:"A hub for trade \u2014 lifts what every caf\u00e9 and bakery nearby takes.", cat:"trade"},
  {id:"workshop",name:"Workshop",cost:100,key:"x", desc:"Makes goods to sell. A market nearby is worth a great deal to it.", cat:"trade"},
  {id:"sawmill",name:"Sawmill", cost:85, key:"w", desc:"Cuts timber. Earns more the more woodland stands within five tiles.", cat:"trade"},
  {id:"inn",   name:"Inn",     cost:120,key:"n", desc:"Puts up travellers. Earns from every station and dock within six tiles.", cat:"trade"},
