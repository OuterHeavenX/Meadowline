...
export const TOOLS=[
  ...
  {id:"rail",  name:"Rail",   cost:8,   key:"3", desc:"Draw a loop and trains will run it on their own. Crosses water too.", cat:"ways", unlock:20},
  {id:"station",name:"Station",cost:110,key:"0", desc:"Must touch a rail tile. Lifts homes for six tiles.", cat:"ways", unlock:40},
  {id:"dock",  name:"Dock",   cost:70, key:"d", desc:"Must touch water. Boats put out from here and sail the lake.", cat:"ways", unlock:60},
  {id:"signal",name:"Signal",  cost:25, key:"z", desc:"Sits on a road. Keeps a busy crossroads in order \u2014 and the traffic stops at red.", cat:"ways", unlock:25},
  {id:"house", name:"House",  cost:24,  key:"4", desc:"Four neighbours move in once they're happy.", cat:"homes"},
  {id:"school",name:"School", cost:145,key:"c", desc:"Room for two more in every home it reaches, and a fine mood lift.", cat:"homes", unlock:50},
  {id:"clinic",name:"Clinic",  cost:160,key:"h", desc:"Takes the edge off a crowded street, and lifts the mood for five tiles.", cat:"homes", unlock:100},
  {id:"well",  name:"Well",    cost:15, key:"j", desc:"A small, cheap comfort for the houses right around it.", cat:"homes"},
  {id:"farm",  name:"Farm",    cost:60, key:"f", desc:"Grows the grain the windmills need. Wants open ground around it.", cat:"food", unlock:12},
  {id:"mill",  name:"Windmill",cost:95, key:"9", desc:"Grinds coin every day \u2014 most of all at harvest. Wants open ground.", cat:"food", unlock:20},
  {id:"bakery",name:"Bakery", cost:80, key:"k", desc:"Bakes what the windmills grind. Wants a mill within four tiles.", cat:"food", unlock:35},
  {id:"cafe",  name:"Caf\u00e9",   cost:55,  key:"5", desc:"Earns coins every day and cheers up the street.", cat:"food", unlock:8},
  {id:"market",name:"Market", cost:130,key:"r", desc:"A hub for trade \u2014 lifts what every caf\u00e9 and bakery nearby takes.", cat:"trade", unlock:30},
  {id:"workshop",name:"Workshop",cost:100,key:"x", desc:"Makes goods to sell. A market nearby is worth a great deal to it.", cat:"trade", unlock:55},
  {id:"sawmill",name:"Sawmill", cost:85, key:"w", desc:"Cuts timber. Earns more the more woodland stands within five tiles.", cat:"trade", unlock:65},
  {id:"inn",   name:"Inn",     cost:120,key:"n", desc:"Puts up travellers. Earns from every station and dock within six tiles.", cat:"trade", unlock:80},
  ...
  {id:"statue",name:"Statue",  cost:900,key:"y", desc:"A wonder. One only. Something for the whole valley to be proud of.", cat:"wonder"},
  {id:"clocktower",name:"Clock Tower",cost:1600,key:"t", desc:"A wonder. One only. Everyone works a little better to its hours.", cat:"wonder"},
  {id:"lighthouse",name:"Lighthouse",cost:2000,key:"g", desc:"A wonder. One only, at the water's edge. It calls the boats in.", cat:"wonder"},
  {id:"library",name:"Great Library",cost:2600,key:"u", desc:"A wonder. One only. Room for one more in every home in the valley.", cat:"wonder"},
...
export const ICONS={
  ...
  signal:'<path d="M12 21v-4M8.5 3.5h7v10h-7v-10Z"/><circle cx="12" cy="6.6" r="1.1"/><circle cx="12" cy="10.4" r="1.1"/>',
  ...
  farm:'<path d="M3 20.5h18M4.5 20.5V11l7.5-5.5L19.5 11v9.5M9 20.5v-5.5h6v5.5M4.5 11h15"/>',
  sawmill:'<path d="M3 20.5h18M5 20.5V9l6-3.5V9h8v11.5M8 13h0.01M8 16.5h0.01M14 13.5v3.5M17 13.5v3.5"/>',
  workshop:'<path d="M3 20.5h18M5 20.5v-9l4.5-3 4.5 3v9M14 20.5v-6h5v6M7 14.5h2M7 17.5h2M16 17h1"/>',
  inn:'<path d="M4 20.5h16M5.5 20.5V9.5L12 4.5l6.5 5v11M9.5 20.5v-5h5v5M12 8.5v2.5M10.5 12.5h3"/>',
  clinic:'<path d="M4.5 20.5h15V8.5L12 4l-7.5 4.5v12M12 9.5v6M9 12.5h6"/>',
  well:'<path d="M6 20.5h12M7.5 20.5v-8h9v8M5.5 12.5h13M12 12.5V6.5M8.5 6.5h7l-1.5-2h-4l-1.5 2Z"/>',
  statue:'<path d="M5 21h14M8 21v-2.5h8V21M12 18.5V9M12 9a2.2 2.2 0 1 0 0-4.4A2.2 2.2 0 0 0 12 9ZM12 11.5 8.5 14M12 11.5 15.5 14"/>',
  clocktower:'<path d="M8 21V8.5h8V21M8 8.5 12 3l4 5.5M6.5 21h11M12 11.5v3l2 1.2"/><circle cx="12" cy="13.5" r="3.4"/>',
  lighthouse:'<path d="M9 21h6l-1-11h-4l-1 11ZM10 10V7.5h4V10M10.6 7.5 12 4l1.4 3.5M4 8.5l4 1M20 8.5l-4 1M5 13l3 .6M19 13l-3 .6"/>',
  library:'<path d="M12 3.5 21 8l-9 4.5L3 8l9-4.5ZM5.5 10v7.5c0 1.6 2.9 2.9 6.5 2.9s6.5-1.3 6.5-2.9V10M12 12.5v7.9"/>',
