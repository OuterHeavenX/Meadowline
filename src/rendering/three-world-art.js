...
function storefront(g,type,seed){const colors={cafe:'#c98666',market:'#9db7a5',bakery:'#d8b56f',station:'#aaa99e',generalStore:'#c2b393',teaHouse:'#b9a7c4',bookshop:'#8fa9c0'},wall=colors[type]||'#c8c3b2',accent=type==='cafe'?'#7e3f36':type==='market'?'#4f765e':type==='bakery'?'#9a633d':type==='generalStore'?'#6d5b3d':type==='teaHouse'?'#6a4d78':type==='bookshop'?'#3f5a76':'#576b76';
