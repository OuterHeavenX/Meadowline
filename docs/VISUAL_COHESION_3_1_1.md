...
Natural trees are presentation-thinned deterministically, reduced beside development, capped at 260 near and 120 far, and rendered from one coherent broadleaf/conifer family. Saved natural-tree and player-tree state is never deleted. Housing roof tendencies share a cheap district hash, creating neighborhood rhythm without a style simulation.
